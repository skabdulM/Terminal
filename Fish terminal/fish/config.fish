...
#oh-my-posh init pwsh --config /home/abdulmannan/.poshthemes/blue-owl.omp.json | Invoke-Expression
#oh-my-posh init fish --config /home/abdulmannan/.poshthemes/mt.omp.json  | source
